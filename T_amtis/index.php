...
function calculateElectricityCharge($voltage, $current, $rate) {
    ...
    // Fetch the maximum existing value of "hour"
    ...
    // Set the initial hour value to 1 if no records exist, otherwise increment it
    $nextHour = $maxHourData['maxHour'] ? $maxHourData['maxHour'] + 1 : 1;

    // Insert data into the database with the generated "hour" value
